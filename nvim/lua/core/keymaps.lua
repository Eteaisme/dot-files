...
vim.api.nvim_create_autocmd("FileType", {
	pattern = "typst",
	callback = function()
		-- Live preview in browser (updates as you type, no save needed)
		vim.keymap.set("n", "<Leader>p", "<cmd>TypstPreviewToggle<cr>", 
			{ buffer = true, silent = true, desc = "Toggle Typst Preview" })
		
		-- Alternative: zathura preview (requires manual save)
		...
		end, { buffer = true, silent = true, desc = "Open in Zathura" })
	end,
})
